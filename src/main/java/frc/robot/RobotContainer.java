...
public class RobotContainer {
  ...
  private final frc.robot.util.common.XboxController primaryController = new frc.robot.util.common.XboxController(0);
  ...
  private frc.robot.util.common.Axis getDriveForwardAxis() {
    return primaryController.getLeftYAxis();
  }

  private frc.robot.util.common.Axis getDriveStrafeAxis() {
    return primaryController.getLeftXAxis();
  }

  private frc.robot.util.common.Axis getDriveRotationAxis() {
  ...
  public frc.robot.util.common.XboxController getPrimaryController() {
