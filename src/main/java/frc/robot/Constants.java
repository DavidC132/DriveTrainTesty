...
public class Constants {
    ...
    public static final int DRIVETRAIN_FRONT_LEFT_ENCODER_PORT = 12;
    public static final int DRIVETRAIN_FRONT_RIGHT_ENCODER_PORT = 11;
    public static final int DRIVETRAIN_BACK_LEFT_ENCODER_PORT = 10;
    public static final int DRIVETRAIN_BACK_RIGHT_ENCODER_PORT = 9;
